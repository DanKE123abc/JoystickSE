...
namespace Dewity
{
    ...
    public class Requests
    {
        ...
        public static string Get(string url, string param = "",string UserAgent = "DewityRequests", string Method = "GET", string
            Accept = "'*/*'")
        {
        ...
        /// <returns>所代表远程资源的响应结果</returns>
        public static string Get(string url, string param = "", string encoding = "", string UserAgent = "DewityRequests", string Method = "GET", string
            Accept = "'*/*'")
        {
            string result = String.Empty;
            StreamReader reader = null;
        ...
        /// <returns>所代表远程资源的响应结果</returns>
        public static string Post(string url, string jsonData , string UserAgent = "DewityRequests", string Method = "POST", string
        ...
        /// <param name="encoding">设置响应信息的编码格式，如utf-8</param>
        /// <returns>所代表远程资源的响应结果</returns>
        public static string Post(string url, string jsonData, string encoding = "",string UserAgent = "DewityRequests", string Method = "POST", string
            Accept = "'*/*'", string ContentType = "application/x-www-form-urlencoded",CookieContainer cookie = null)
        {
            string result = String.Empty;
            try
        ...
        public static bool Download(string url, string path, string UserAgent = "DewityRequests")
        {
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(url);
            request.UserAgent =  UserAgent;
            //发送请求并获取相应回应数据
