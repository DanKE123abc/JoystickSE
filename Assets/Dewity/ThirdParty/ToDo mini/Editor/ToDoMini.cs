...
namespace ToDoMini
{
    ...
    public class ToDoMini : EditorWindow
    {
        ...
        [MenuItem("ToDo 清单/ToDo 清单 %t")]
        public static void Open()
        {
            // Get existing open window or if none, make a new one.
            window = (ToDoMini)GetWindow(typeof(ToDoMini));
            window.titleContent = new GUIContent("☑ ToDo 清单");
        ...
        void DrawCurrentTasks()
        {
            ...
            if (!hasUncompletedTasks)
                EditorGUILayout.LabelField("没有未完成的任务.", EditorStyles.largeLabel);
        }
        ...
        void DrawCompletedTasksButton()
        {
            ...
            {
                if (GUILayout.Button("显示 已完成的任务"))
                    shouldDrawCompletedTasks = true;
            }
            else if (GUILayout.Button("隐藏 已完成的任务"))
        ...
        void DrawCompletedTasks()
        {
            ...
            if (!hasCompletedTasks)
                EditorGUILayout.LabelField("没有已完成的任务.", EditorStyles.largeLabel);
        }
        #endregion
        ...
        void DrawNewTaskPanel()
        {
            ...
            // "Add" button.
            if ((GUILayout.Button("+ 添加任务") || returnWasPressed) && !string.IsNullOrEmpty(newTask))
            {
