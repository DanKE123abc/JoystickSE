...
namespace Dewity
{
    ...
    public class GameConsole : MonoSingleton<GameConsole>
    {
        ...
        public void Init()
        {
            DewityDataModel model = DewityConfig.instance.GetModel();
            allowDebugging = (bool)model.ManagerConfig.GameConsole;
        }
        ...
        private void ExpansionGUIWindow(int windowId)
        {
            ...
            if (GUILayout.Button("FPS:" + fps, GUILayout.Height(30)))
            {
                expansion = false;
